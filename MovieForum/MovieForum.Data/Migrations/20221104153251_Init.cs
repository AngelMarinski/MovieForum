    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, null, "adminsemail@gmail.com", "Maggie", "anais.png", false, false, "TheBoss", "AQAAAAEAACcQAAAAEBiWmLOzQhNQNEuK8vZ0RfW4F733JlP8Pc2S/ZhnG275mzoOHhKhi/zl/WoX8y6E6A==", null, 1, "Maggie" },
                    { 3, null, "morefakeemails@gmail.com", "Radoslav", "darw.png", false, false, "Berov", "AQAAAAEAACcQAAAAEL5OAitijnzWiQm39T4j9tiuRfwQxW2w9mOSwmiSIAjB7Kyb1mLrs94hpxjlxG+v2A==", null, 1, "Rado561" },
                    { 4, null, "agent007@gmail.com", "James", "bond.png", false, false, "Bond", "AQAAAAEAACcQAAAAEI8U3/btzzuHUi6Ti97LGyEQGy+W7U4agpqkj8ut2cUXtzkJDCxs1pQ/r/pNG0TTAg==", null, 1, "James96" },
                    { 5, null, "mzfb@gmail.com", "Mark", "marck.jpg", false, false, "zuckerberg", "AQAAAAEAACcQAAAAECUQhlds4aZMJXeVjD1AyMjqzK6PUaFVAg+CyRU81obwc77KehGwxtoFHKwpy++/xg==", null, 1, "MarkZ" },
                    { 1, null, "fakeemail@gmail.com", "Angel", "gum.jpg", false, false, "Marinski", "AQAAAAEAACcQAAAAEA8tKThimtH7XdcPwUVihmq2DJG7BKd9TFZ5WxfXpq0ra26pVSPhHcUmekw/8oAuGg==", null, 2, "AngelMarinski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 2, "Amazing movie! I strongly recomend it!", null, 0, false, 0, 2, new DateTime(2022, 11, 4, 17, 32, 50, 368, DateTimeKind.Local).AddTicks(5559) },
                    { 1, 1, "This movie is awful!", null, 0, false, 0, 1, new DateTime(2022, 11, 4, 17, 32, 50, 360, DateTimeKind.Local).AddTicks(2204) },
                    { 5, 5, "One of the greatest mindblowing movies of all the times!", null, 0, false, 0, 5, new DateTime(2022, 11, 4, 17, 32, 50, 368, DateTimeKind.Local).AddTicks(5803) },
                    { 3, 3, "It's not as good as the first and repeats the first film's plot but 2 Fast 2 Furious is still fun due to great performances from Paul Walker and Tyrese Gibson and their great chemistry. The enjoyable and over the top action helps as well.!", null, 0, false, 0, 3, new DateTime(2022, 11, 4, 17, 32, 50, 368, DateTimeKind.Local).AddTicks(5783) },
                    { 4, 4, "The concept of the movie was good, but needed to be taken a bit further in my opinion with detail. A lot happens in the movie that basically requires the audience to accept without question.\r\n", null, 0, false, 0, 4, new DateTime(2022, 11, 4, 17, 32, 50, 368, DateTimeKind.Local).AddTicks(5798) }
                });
