    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, null, "adminsemail@gmail.com", "Maggie", "anais.png", false, false, true, "TheBoss", "AQAAAAEAACcQAAAAEPe5LQ/M4j5EwJfAxTZiPZq1GTT6xjVJV9O/j3vGYm3IWkB03E8YDw4z0L1/soi8yA==", null, 1, "Maggie" },
                    { 3, null, "morefakeemails@gmail.com", "Radoslav", "darw.png", false, false, true, "Berov", "AQAAAAEAACcQAAAAEHzy3sxwos7yJN+Mp1pyUL2Te7s0jE/40L7x+05rA2aXJ+zYHLIbM/P6fJnYoc5GNg==", null, 1, "Rado561" },
                    { 4, null, "agent007@gmail.com", "James", "bond.png", false, false, true, "Bond", "AQAAAAEAACcQAAAAEHcwFfNE7Y5Cf1wf4L1NnAxQk28ZLfIcvW3HsVdC07q6GBKKrp9w6vvRUi6dGARw+Q==", null, 1, "James96" },
                    { 5, null, "mzfb@gmail.com", "Mark", "marck.jpg", false, false, true, "zuckerberg", "AQAAAAEAACcQAAAAEMttkl2cnjR+GdBeEa85P49c7bd3x0ViDpjJlj8z6TboXM6GXnON0MVXEWwHvGHHpw==", null, 1, "MarkZ" },
                    { 1, null, "fakeemail@gmail.com", "Angel", "gum.jpg", false, false, true, "Marinski", "AQAAAAEAACcQAAAAEAysoiTt6oB1u4poBwj3Ax8GBSj9ZQzyJj2hDQ2v5K/DuLK/scCqW80vyXBB61Tl+w==", null, 2, "AngelMarinski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 2, "Amazing movie! I strongly recomend it!", null, 0, false, 0, 2, new DateTime(2022, 11, 4, 22, 2, 53, 151, DateTimeKind.Local).AddTicks(1885) },
                    { 1, 1, "This movie is awful!", null, 0, false, 0, 1, new DateTime(2022, 11, 4, 22, 2, 53, 146, DateTimeKind.Local).AddTicks(8690) },
                    { 5, 5, "One of the greatest mindblowing movies of all the times!", null, 0, false, 0, 5, new DateTime(2022, 11, 4, 22, 2, 53, 151, DateTimeKind.Local).AddTicks(1958) },
                    { 3, 3, "It's not as good as the first and repeats the first film's plot but 2 Fast 2 Furious is still fun due to great performances from Paul Walker and Tyrese Gibson and their great chemistry. The enjoyable and over the top action helps as well.!", null, 0, false, 0, 3, new DateTime(2022, 11, 4, 22, 2, 53, 151, DateTimeKind.Local).AddTicks(1945) },
                    { 4, 4, "The concept of the movie was good, but needed to be taken a bit further in my opinion with detail. A lot happens in the movie that basically requires the audience to accept without question.\r\n", null, 0, false, 0, 4, new DateTime(2022, 11, 4, 22, 2, 53, 151, DateTimeKind.Local).AddTicks(1953) }
                });
